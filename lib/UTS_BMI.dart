  ...
  void hitung() {
    setState(() {
      ...
      if (hasil >= 18.5 && hasil < 23) {
        teks =
            "$nama, Anda masuk dalam kategori Sehat, tetap jaga kesehatan yah ;)";
      } else if (hasil >= 23 && hasil < 25) {
        teks =
            "$nama, Anda masuk dalam kategori Kelebihan Berat Badan, mulailah menjaga pol Makan";
      } else if (hasil >= 25 && hasil < 30) {
        teks =
            "$nama, Anda masuk dalam kategori sangat kelebihan Berat Badan (obese Level 1)";
      } else if (hasil >= 30) {
        teks =
            "$nama, Anda masuk dalam kategori sangat Kelebihan Berat Badan, (obese level 2)";
      } else if (hasil >= 17) {
        teks =
            "$nama, Anda masuk dalam kategori Kekurangan Berat Badan, mulailah perbaiki gizi anda";
      } else {
        teks =
            "$nama, Anda masuk dalam kategori sangat kekurangan Berat Badan, mulailah perbaiki gizi dan olahraga";
      }
    });
  }
